...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  DailyContextStep — Dynamic Flow Step 1
 * ═══════════════════════════════════════════════════════════════════
 *
 *  Asks the student what topic is on their mind today.
 *  Options: Friends / School / Myself
 *
 *  This is the entry point for the dynamic flow.
 *  The selection determines the context for subsequent screens.
 * ═══════════════════════════════════════════════════════════════════
 */

export function DailyContextStep({ onSelect }) {
  return (
