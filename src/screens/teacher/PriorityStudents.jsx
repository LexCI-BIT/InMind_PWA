...
export function PriorityStudents() {
  ...
  // Repeated exactly as in the mockup
  const students = [
    { name: 'Alex Johnson', status: 'Low engagement for 2 days', dashOffset: 80 },
    { name: 'J Sreedharan', status: 'Low engagement for 2 days', dashOffset: 60 },
    { name: 'James', status: 'Low engagement for 2 days', dashOffset: 40 },
    { name: 'Alex Johnson', status: 'Low engagement for 2 days', dashOffset: 80 },
    { name: 'J Sreedharan', status: 'Low engagement for 2 days', dashOffset: 60 },
    { name: 'James', status: 'Low engagement for 2 days', dashOffset: 40 },
  ];
    ...
    <button className="w-full text-left bg-white rounded-[20px] p-4 flex items-center justify-between border border-gray-100 shadow-[0_4px_16px_rgba(0,0,0,0.03)] hover:bg-gray-50 transition">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <span className="text-[11px] font-bold text-[#f97316]">{status}</span>
        </div>
      </div>
